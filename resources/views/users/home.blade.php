...
@section('content')
        ...
        <div class="row">
            <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <p class="card-title text-md-center text-xl-left">Unpurchased products</p>
                        <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                            <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">
                                {{$shoppingcart->count()}}
{{--                                @foreach($shoppingcart as $item)--}}
{{--                                    @if(\Illuminate\Support\Facades\Auth::user() === $shoppingcart[$item]->user())--}}
{{--                                        {{$shoppingcart->count()}}--}}
{{--                                    @endif--}}
{{--                                    {{$item->count()}}--}}
{{--                                @endforeach--}}
            ...
            {{-- <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <p class="card-title text-md-center text-xl-left">Purchased products</p>
                        <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
